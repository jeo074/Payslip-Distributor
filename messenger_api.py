...
def get_psids(msgr, fb_accounts):
    ...
    page_count = 1
    psids = {}
    url = 'https://graph.facebook.com/v{}/{}/conversations?fields=participants&access_token={}'.format(fb_api_version, page_id, page_access_token)
...
def send_message(msgr, psid, message):
    ...
    url = 'https://graph.facebook.com/v{}/{}/messages?access_token={}'.format(fb_api_version, page_id, page_access_token)
